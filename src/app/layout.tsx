...
<p>
Disclaimer: this app provides content for wellness & entertainment purposes only. It does not
replace professional medical, legal, or financial advice.
</p>
<p>
Transparency: MVP uses Whole Sign houses when birth time is available; otherwise a solar chart (no houses/ASC) with orbs simplified.
</p>
</div>
</footer>
</body>
